# Ignite UI for React Inputs - from Infragistics
...
This package is specifically the inputs components for Ignite UI for React.


## NPM Package

You can include Ignite UI for React Inputs in your project as a dependency using the NPM package.

`npm install igniteui-react-inputs igniteui-react-core --save`
