...
import { markType, Base, StringBuilder, List$1, Delegate_$type, fromEnum, runOn, NativeUI, ScaleTransform, KeyFrameAnimationFactory, AnimationKeyFrameEffect, LinkedList$1, IKeyFrameAnimation_$type, PropertyChangedEventArgs, AnimationKeyFrameProperty, AnimationKeyFrameEffectTiming, AppearanceHelper, INotifyPropertyChanged_$type, BrushUtil, markEnum, EventArgs, stringIsNullOrEmpty, isNaN_, CornerRadius, Thickness, enumGetBox, ControlDisplayDensity_$type, BaseControlTheme_$type, ElevationMode_$type, FontUtil, IIcon_$type, DomWrapper_$type, dateNow, toNullable, Date_$type, dateAddYears, ObservableCollection$1, nullableNotEquals, dateFromValues, unwrapNullable, dateAddDays, dateGetMonth, dateAddMonths, NamePatcher, ReactRenderer, getModifiedProps, isValidProp, ensureEnum, brushToString, stringToBrush, FontInfo, toSpinal, initializePropertiesFromCss, delegateRemove, delegateCombine, ensureBool, TypeRegistrar, PortalManager, IgrChildContentModule, String_$type, Dictionary$2, Number_$type, stringReplace, TransformGroup, TranslateTransform, MouseButtonEventArgs, Point_$type, KeyEventArgs, typeGetValue, typeCast, fromEn, dateToStringFormat, nullableEquals, IgrKeyEventArgs, SyncableObservableCollection$2, IgCollection, ContentChildrenManager, CollectionAdapter, NotifyCollectionChangedAction, RotateTransform } from 'igniteui-react-core';
...
var ValueChangedEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ValueChangedEventArgs.$t = markType(ValueChangedEventArgs, 'ValueChangedEventArgs', EventArgs.$);
...
var CalendarVisualModelExport = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CalendarVisualModelExport, _super);
    ...
    CalendarVisualModelExport.$t = markType(CalendarVisualModelExport, 'CalendarVisualModelExport');
...
var IgrButton = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrButton.prototype.render = function () {
        ...
        var children = [];
        Children.forEach(propChildren, function (ch) {
 ...
 * @hidden
 */
var SuffixShiftType_$type = /*@__PURE__*/ markEnum('SuffixShiftType', 'Line,0|Box,1|Border,2');
 ...
 * @hidden
 */
var PrefixShiftType_$type = /*@__PURE__*/ markEnum('PrefixShiftType', 'Line,0|Box,1|Border,2');
 ...
 * @hidden
 */
var LabelShiftType_$type = /*@__PURE__*/ markEnum('LabelShiftType', 'Line,0|Box,1|Border,2');
 ...
 * @hidden
 */
var InputShiftType_$type = /*@__PURE__*/ markEnum('InputShiftType', 'Line,0|Box,1|Border,2');
 ...
 * @hidden
 */
var InputGroupDisplayType_$type = /*@__PURE__*/ markEnum('InputGroupDisplayType', 'Line,0|Box,1|Border,2|Search,3');
...
var InputChangeEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(InputChangeEventArgs, _super);
    ...
    InputChangeEventArgs.$t = markType(InputChangeEventArgs, 'InputChangeEventArgs', EventArgs.$);
...
var InputGroupItem = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(InputGroupItem, _super);
    ...
    InputGroupItem.$t = markType(InputGroupItem, 'InputGroupItem', Base.$, [INotifyPropertyChanged_$type]);
...
var Suffix = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Suffix.$t = markType(Suffix, 'Suffix', InputGroupItem.$);
    Suffix.s = 0;
    return Suffix;
}(InputGroupItem));
/**
...
var Prefix = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Prefix.$t = markType(Prefix, 'Prefix', InputGroupItem.$);
    Prefix.s = 0;
    return Prefix;
}(InputGroupItem));
/**
...
var InputGroup = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function InputGroup() {
        ...
        _this.bh = NaN;
        _this.nt = null;
        _this.mw = new CornerRadius(1, NaN, NaN, NaN, NaN);
        _this.tc = new Thickness(1, NaN, NaN, NaN, NaN);
        _this.b9 = NaN;
        _this.b8 = NaN;
        _this.bl = NaN;
        _this.op = null;
        ...
        _this.od = null;
        _this.oc = null;
        _this.mx = new CornerRadius(1, NaN, NaN, NaN, NaN);
        _this.td = new Thickness(1, NaN, NaN, NaN, NaN);
        _this.bv = NaN;
        _this.bu = NaN;
        _this.br = NaN;
        _this.og = null;
        ...
        _this.n3 = null;
        _this.n2 = null;
        _this.mv = new CornerRadius(1, NaN, NaN, NaN, NaN);
        _this.tb = new Thickness(1, NaN, NaN, NaN, NaN);
        _this.bg = NaN;
        _this.bf = NaN;
        _this.bc = NaN;
        _this.n6 = null;
        ...
        _this.nw = null;
        _this.nv = null;
        _this.mu = new CornerRadius(1, NaN, NaN, NaN, NaN);
        _this.ta = new Thickness(1, NaN, NaN, NaN, NaN);
        _this.a5 = NaN;
        _this.a4 = NaN;
        _this.a1 = NaN;
        _this.nz = null;
        ...
        _this.ok = null;
        _this.oj = null;
        _this.my = new CornerRadius(1, NaN, NaN, NaN, NaN);
        _this.te = new Thickness(1, NaN, NaN, NaN, NaN);
        _this.b5 = NaN;
        _this.b4 = NaN;
        _this.b1 = NaN;
        _this.on = null;
        ...
        _this.s = false;
        _this.aa = false;
        _this.h9 = toNullable(Number_$type, null);
        var a = new InputGroupView();
        a.d = _this;
        _this.view = a;
        _this.view.ag();
        var b = _this.l;
        b.collectionChanged = delegateCombine(b.collectionChanged, runOn(_this, _this.lx));
        var c = _this.l;
        c.collectionResetting = delegateCombine(c.collectionResetting, runOn(_this, _this.ly));
        return _this;
    }
    ...
    InputGroup.prototype.l1 = function () {
        ...
        if (this.p == null) {
            this.p = KeyFrameAnimationFactory.f.c(this.view.b(this.a).m(new AnimationKeyFrameProperty(2, this.ot), new AnimationKeyFrameProperty(14, ((function () {
                var $ret = new ScaleTransform();
                $ret.l = 0.5;
                $ret.m = 1;
                return $ret;
            })())), new AnimationKeyFrameProperty(1, 0)).m(new AnimationKeyFrameProperty(2, this.ot), new AnimationKeyFrameProperty(14, ((function () {
                var $ret = new ScaleTransform();
                $ret.l = 1;
                $ret.m = 1;
                return $ret;
    ...
    Object.defineProperty(InputGroup.prototype, "h7", {
        get: function () {
            if (!this.h9.hasValue) {
                ...
                this.h9 = toNullable(Number_$type, a_1);
            }
    ...
    InputGroup.$t = markType(InputGroup, 'InputGroup', Base.$, [INotifyPropertyChanged_$type]);
    InputGroup.c = 2;
    InputGroup.fu = 0;
    InputGroup.f5 = 0;
    InputGroup.nf = new CornerRadius(1, 0, 0, 0, 0);
    InputGroup.tv = new Thickness(1, 0, 0, 0, 0);
    InputGroup.rd = BrushUtil.g(138, 0, 0, 0);
    InputGroup.ru = BrushUtil.g(255, 0, 153, 155);
    InputGroup.rv = BrushUtil.g(255, 0, 153, 155);
    InputGroup.gx = 1;
    InputGroup.gw = 2;
    InputGroup.f9 = 2;
    InputGroup.se = BrushUtil.g(138, 0, 0, 0);
    InputGroup.sf = BrushUtil.g(255, 0, 153, 155);
    InputGroup.rx = BrushUtil.g(138, 0, 0, 0);
    InputGroup.rw = BrushUtil.g(255, 0, 153, 155);
    InputGroup.gu = 1;
    InputGroup.f8 = 1;
    InputGroup.f6 = 1;
    InputGroup.f7 = 1;
    InputGroup.gv = 0;
    InputGroup.rc = BrushUtil.g(0, 0, 0, 0);
    InputGroup.ga = 0;
    InputGroup.gb = 0;
    InputGroup.ng = new CornerRadius(1, 0, 0, 0, 0);
    InputGroup.tw = new Thickness(1, 0, 0, 0, 0);
    InputGroup.rz = BrushUtil.g(138, 0, 0, 0);
    InputGroup.r0 = BrushUtil.g(255, 0, 153, 155);
    InputGroup.r1 = BrushUtil.g(255, 0, 153, 155);
    InputGroup.gj = 1;
    InputGroup.gi = 2;
    InputGroup.gf = 2;
    InputGroup.r4 = BrushUtil.g(138, 0, 0, 0);
    InputGroup.r5 = BrushUtil.g(255, 0, 153, 155);
    InputGroup.r3 = BrushUtil.g(138, 0, 0, 0);
    InputGroup.r2 = BrushUtil.g(255, 0, 153, 155);
    InputGroup.gg = 1;
    InputGroup.ge = 1;
    InputGroup.gc = 1;
    InputGroup.gd = 1;
    InputGroup.gh = 0;
    InputGroup.ry = BrushUtil.g(0, 0, 0, 0);
    InputGroup.fv = 0;
    InputGroup.fw = 0;
    InputGroup.ne = new CornerRadius(1, 4, 4, 0, 0);
    InputGroup.tu = new Thickness(1, 16, 0, 16, 0);
    InputGroup.rn = BrushUtil.g(138, 0, 0, 0);
    InputGroup.ro = BrushUtil.g(255, 0, 153, 155);
    InputGroup.rp = BrushUtil.g(255, 0, 153, 155);
    InputGroup.f4 = 1;
    InputGroup.f3 = 2;
    InputGroup.f0 = 2;
    InputGroup.rs = BrushUtil.g(138, 0, 0, 0);
    InputGroup.rt = BrushUtil.g(255, 0, 153, 155);
    InputGroup.rr = BrushUtil.g(138, 0, 0, 0);
    InputGroup.rq = BrushUtil.g(255, 0, 153, 155);
    InputGroup.f1 = 1;
    InputGroup.fz = 1;
    InputGroup.fx = 1;
    InputGroup.fy = 1;
    InputGroup.f2 = 0;
    InputGroup.rm = BrushUtil.g(20, 0, 0, 0);
    InputGroup.fk = 1;
    InputGroup.fl = 2;
    InputGroup.nd = new CornerRadius(1, 4, 4, 4, 4);
    InputGroup.tt = new Thickness(1, 16, 0, 16, 0);
    InputGroup.rf = BrushUtil.g(138, 0, 0, 0);
    InputGroup.rg = BrushUtil.g(255, 0, 153, 155);
    InputGroup.rh = BrushUtil.g(255, 0, 153, 155);
    InputGroup.ft = 1;
    InputGroup.fs = 2;
    InputGroup.fp = 2;
    InputGroup.rk = BrushUtil.g(138, 0, 0, 0);
    InputGroup.rl = BrushUtil.g(255, 0, 153, 155);
    InputGroup.rj = BrushUtil.g(138, 0, 0, 0);
    InputGroup.ri = BrushUtil.g(255, 0, 153, 155);
    InputGroup.fq = 0;
    InputGroup.fo = 0;
    InputGroup.fm = 0;
    InputGroup.fn = 0;
    InputGroup.fr = 0;
    InputGroup.re = BrushUtil.g(0, 0, 0, 0);
    InputGroup.gk = 1;
    InputGroup.gl = 2;
    InputGroup.nh = new CornerRadius(1, 4, 4, 4, 4);
    InputGroup.tx = new Thickness(1, 16, 0, 16, 0);
    InputGroup.r7 = BrushUtil.g(138, 0, 0, 0);
    InputGroup.r8 = BrushUtil.g(255, 0, 153, 155);
    InputGroup.r9 = BrushUtil.g(255, 0, 153, 155);
    InputGroup.gt = 1;
    InputGroup.gs = 2;
    InputGroup.gp = 2;
    InputGroup.sc = BrushUtil.g(138, 0, 0, 0);
    InputGroup.sd = BrushUtil.g(255, 0, 153, 155);
    InputGroup.sb = BrushUtil.g(138, 0, 0, 0);
    InputGroup.sa = BrushUtil.g(255, 0, 153, 155);
    InputGroup.gq = 0;
    InputGroup.go = 0;
    InputGroup.gm = 0;
    InputGroup.gn = 0;
    InputGroup.gr = 0;
    InputGroup.r6 = BrushUtil.g(0, 0, 0, 0);
    InputGroup.d1 = 0;
    InputGroup.ec = 0;
    InputGroup.m9 = new CornerRadius(1, 0, 0, 0, 0);
    InputGroup.tp = new Thickness(1, 0, 0, 0, 0);
    InputGroup.px = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qe = BrushUtil.g(255, 33, 150, 243);
    InputGroup.qf = BrushUtil.g(255, 33, 150, 243);
    InputGroup.e4 = 1;
    InputGroup.e3 = 2;
    InputGroup.eg = 2;
    InputGroup.qy = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qz = BrushUtil.g(255, 33, 150, 243);
    InputGroup.qh = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qg = BrushUtil.g(255, 33, 150, 243);
    InputGroup.e1 = 1;
    InputGroup.ef = 1;
    InputGroup.ed = 1;
    InputGroup.ee = 1;
    InputGroup.e2 = 0;
    InputGroup.pw = BrushUtil.g(0, 0, 0, 0);
    InputGroup.eh = 0;
    InputGroup.ei = 0;
    InputGroup.na = new CornerRadius(1, 0, 0, 0, 0);
    InputGroup.tq = new Thickness(1, 0, 0, 0, 0);
    InputGroup.qj = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qk = BrushUtil.g(255, 33, 150, 243);
    InputGroup.ql = BrushUtil.g(255, 33, 150, 243);
    InputGroup.eq = 1;
    InputGroup.ep = 2;
    InputGroup.em = 2;
    InputGroup.qo = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qp = BrushUtil.g(255, 33, 150, 243);
    InputGroup.qn = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qm = BrushUtil.g(255, 33, 150, 243);
    InputGroup.en = 1;
    InputGroup.el = 1;
    InputGroup.ej = 1;
    InputGroup.ek = 1;
    InputGroup.eo = 0;
    InputGroup.qi = BrushUtil.g(0, 0, 0, 0);
    InputGroup.d2 = 0;
    InputGroup.d3 = 0;
    InputGroup.m8 = new CornerRadius(1, 4, 4, 0, 0);
    InputGroup.to = new Thickness(1, 16, 0, 16, 0);
    InputGroup.p7 = BrushUtil.g(255, 186, 191, 199);
    InputGroup.p8 = BrushUtil.g(255, 33, 150, 243);
    InputGroup.p9 = BrushUtil.g(255, 33, 150, 243);
    InputGroup.eb = 1;
    InputGroup.ea = 2;
    InputGroup.d7 = 2;
    InputGroup.qc = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qd = BrushUtil.g(255, 33, 150, 243);
    InputGroup.qb = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qa = BrushUtil.g(255, 33, 150, 243);
    InputGroup.d8 = 1;
    InputGroup.d6 = 1;
    InputGroup.d4 = 1;
    InputGroup.d5 = 1;
    InputGroup.d9 = 0;
    InputGroup.p6 = BrushUtil.g(20, 0, 0, 0);
    InputGroup.dr = 1;
    InputGroup.ds = 2;
    InputGroup.m7 = new CornerRadius(1, 4, 4, 4, 4);
    InputGroup.tn = new Thickness(1, 16, 0, 16, 0);
    InputGroup.pz = BrushUtil.g(255, 186, 191, 199);
    InputGroup.p0 = BrushUtil.g(255, 33, 150, 243);
    InputGroup.p1 = BrushUtil.g(255, 33, 150, 243);
    InputGroup.d0 = 1;
    InputGroup.dz = 2;
    InputGroup.dw = 2;
    InputGroup.p4 = BrushUtil.g(255, 186, 191, 199);
    InputGroup.p5 = BrushUtil.g(255, 33, 150, 243);
    InputGroup.p3 = BrushUtil.g(255, 186, 191, 199);
    InputGroup.p2 = BrushUtil.g(255, 33, 150, 243);
    InputGroup.dx = 0;
    InputGroup.dv = 0;
    InputGroup.dt = 0;
    InputGroup.du = 0;
    InputGroup.dy = 0;
    InputGroup.py = BrushUtil.g(0, 0, 0, 0);
    InputGroup.er = 1;
    InputGroup.es = 2;
    InputGroup.nb = new CornerRadius(1, 4, 4, 4, 4);
    InputGroup.tr = new Thickness(1, 16, 0, 16, 0);
    InputGroup.qr = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qs = BrushUtil.g(255, 33, 150, 243);
    InputGroup.qt = BrushUtil.g(255, 33, 150, 243);
    InputGroup.e0 = 1;
    InputGroup.ez = 2;
    InputGroup.ew = 2;
    InputGroup.qw = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qx = BrushUtil.g(255, 33, 150, 243);
    InputGroup.qv = BrushUtil.g(255, 186, 191, 199);
    InputGroup.qu = BrushUtil.g(255, 33, 150, 243);
    InputGroup.ex = 0;
    InputGroup.ev = 0;
    InputGroup.et = 0;
    InputGroup.eu = 0;
    InputGroup.ey = 0;
    InputGroup.qq = BrushUtil.g(0, 0, 0, 0);
    InputGroup.h8 = 0;
    return InputGroup;
}(Base));
/**
...
var InputGroupInputCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(InputGroupInputCollection, _super);
    ...
    InputGroupInputCollection.$t = markType(InputGroupInputCollection, 'InputGroupInputCollection', ObservableCollection$1.$.specialize(InputGroupItem.$));
...
var Label = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Label.$t = markType(Label, 'Label', InputGroupItem.$);
    Label.c7 = BrushUtil.g(221, 0, 0, 0);
    Label.c4 = BrushUtil.g(255, 0, 153, 155);
    Label.c6 = BrushUtil.g(221, 0, 0, 0);
    Label.c5 = BrushUtil.g(255, 0, 153, 155);
    Label.c0 = BrushUtil.g(255, 24, 29, 31);
    Label.cx = BrushUtil.g(255, 33, 150, 243);
    Label.cz = BrushUtil.g(255, 24, 29, 31);
    Label.cy = BrushUtil.g(255, 33, 150, 243);
    Label.k = 2;
...
var Input = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Input.$t = markType(Input, 'Input', InputGroupItem.$);
    Input.dr = BrushUtil.g(221, 0, 0, 0);
    Input.dq = BrushUtil.g(221, 0, 0, 0);
    Input.ab = null;
    Input.a9 = 0;
    return Input;
}(InputGroupItem));
...
var IgrInputGroupItem = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrInputGroupItem, _super);
...
var IgrInputGroupInputCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrInputGroupInputCollection, _super);
    ...
    IgrInputGroupInputCollection.prototype._createInnerColl = function () {
        ...
        var coll = new SyncableObservableCollection$2(IgrInputGroupItem.$type, InputGroupItem.$type, 0);
...
var IgrInputGroup = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrInputGroup, _super);
 ...
 * @hidden
 */
var CheckboxLabelPosition_$type = /*@__PURE__*/ markEnum('CheckboxLabelPosition', 'After,0|Before,1');
...
var CheckboxChangeEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CheckboxChangeEventArgs, _super);
    ...
    CheckboxChangeEventArgs.$t = markType(CheckboxChangeEventArgs, 'CheckboxChangeEventArgs', EventArgs.$);
 ...
 * @hidden
 */
var ButtonGroupOrientation_$type = /*@__PURE__*/ markEnum('ButtonGroupOrientation', 'Horizontal,0|Vertical,1');
 ...
 * @hidden
 */
var ButtonGroupDisplayStyle_$type = /*@__PURE__*/ markEnum('ButtonGroupDisplayStyle', 'Flat,0|Outlined,1');
...
var ButtonGroupButtonCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ButtonGroupButtonCollection, _super);
    ...
    ButtonGroupButtonCollection.$t = markType(ButtonGroupButtonCollection, 'ButtonGroupButtonCollection', ObservableCollection$1.$.specialize(Button.$));
...
var IgrButtonGroupButtonCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrButtonGroupButtonCollection, _super);
    ...
    IgrButtonGroupButtonCollection.prototype._createInnerColl = function () {
        ...
        var coll = new SyncableObservableCollection$2(IgrButton.$type, Button.$type, 0);
        coll.compare = function (ext, int) {
            var comp = ext;
            if (comp._implementation) {
                comp = comp._implementation;
...
var IgrButtonGroup = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrButtonGroup, _super);
...
var IgrPrefix = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function IgrPrefix(props) {
        ...
        _this.requestRender = _this.requestRender.bind(_this);
        _this._portalManager = new PortalManager("prefixContent", _this.requestRender);
        var ren = new ReactRenderer(root, document, true, {}, _this._portalManager);
        _this._wrapper = ren;
        _this._container = _this._wrapper.rootWrapper;
        _this._container.setStyleProperty("display", "inline-block");
